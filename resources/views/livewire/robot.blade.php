<div>
 ...
 <small class="text-green-500"> {{ $chosen }} </small>
  ...
  <div class="px-5 py-5 float-right">
   <button wire:click="$emit('openModal','first-tab',{{ json_encode(['id' => $menu_id ]) }})"  class=" text-green-500 hover:bg-green-500 hover:text-white px-3 rounded py-2 border border-green-500"> 
   Next
   </button>
  </div>
